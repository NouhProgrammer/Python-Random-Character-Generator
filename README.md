This is a package you can use to generate random characters for any python project, to use it, simply put the files inside the folder, and in your project import it as a class:
